    ...
    Dep => Dep.extend({
        ...
        getValueForDisplay() {
            ...
            if (this.model.get('type') === 'Field') {
                ...
                if (!this.model.get('exportFeedLanguage') && this.getMetadata().get(`entityDefs.${this.model.get('entity')}.fields.${this.model.get('name')}.isMultilang`) && this.model.get('locale') !== 'main') {
            ...
            if (this.model.get('type') === 'Attribute') {
                ...
                if (!this.model.get('exportFeedLanguage') && this.model.get('isAttributeMultiLang') && this.model.get('locale') !== 'main') {
                    name += ' / ' + this.model.get('locale');
                }
            }
