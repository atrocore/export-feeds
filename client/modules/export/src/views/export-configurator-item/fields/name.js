    ...
    Dep => Dep.extend({
        ...
        getValueForDisplay() {
            ...
            if (this.model.get('type') === 'Field') {
                ...
                if (!this.model.get('exportFeedLanguage') && this.getMetadata().get(`entityDefs.${this.model.get('entity')}.fields.${this.model.get('name')}.isMultilang`) && this.model.get('locale') !== 'mainLocale') {
            ...
            if (this.model.get('type') === 'Attribute') {
                ...
                if (!this.model.get('exportFeedLanguage') && this.model.get('isAttributeMultiLang') && this.model.get('locale') !== 'mainLocale') {
                    name += ' / ' + this.model.get('locale');
                }
            }
